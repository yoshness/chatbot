		...
		<ul class="l-faq__list">
			<li class="l-faq__item js-tab-item">
				<a href="#" class="faq-block js-tab-trigger">
					<h3 class="faq-block__question">「AI(人工知能)型」と「シナリオ型」の違いはなんですか？</h3>
			...
			<li class="l-faq__item js-tab-item">
				<a href="#" class="faq-block js-tab-trigger">
					<h3 class="faq-block__question">導入にはどのような環境が必要ですか？</h3>
					<p class="faq-block__answer js-tab-answer">
			...
			<li class="l-faq__item js-tab-item">
				<a href="#" class="faq-block js-tab-trigger">
					<h3 class="faq-block__question">業種や目的によっておすすめのチャットボットは異なりますか？</h3>
					<p class="faq-block__answer js-tab-answer">
			...
			<li class="l-faq__item js-tab-item">
				<a href="#" class="faq-block js-tab-trigger">
					<h3 class="faq-block__question">導入費用はどのくらいかかりますか？</h3>
					<p class="faq-block__answer js-tab-answer">
			...
			<li class="l-faq__item js-tab-item">
				<a href="#" class="faq-block js-tab-trigger">
					<h3 class="faq-block__question">専門的な知識がありませんが大丈夫ですか？</h3>
					<p class="faq-block__answer js-tab-answer">
