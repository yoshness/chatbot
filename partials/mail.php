<?php 
	...
	if($company && $person && $email) {
		// mail($recipient, $subject_admin, $content_admin, $mailheader);
		// mail($sender, $subject_sender, $content_sender, $mailheader);

		$mail = new PHPMailer(true);
		$mail->CharSet = 'UTF-8';
		$mail->Encoding = 'base64';
		$mail->setFrom('admin@cebushun.sakura.ne.jp', 'Contact Form Mailer');
		...
		$mail2->setFrom('admin@cebushun.sakura.ne.jp', 'Contact Form Mailer');
